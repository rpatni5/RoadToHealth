...
namespace RTH.Helpers
{
    public abstract class NotifyBase : INotifyPropertyChanged, IDataErrorInfo
    {
        ...
        protected void SetValue<T>(string propertyName, T value)
        {
            ...
            {
                throw new ArgumentException(ValidationMessages.Invalid_PropertyName, propertyName);
            }
        ...
        protected T GetValue<T>(string propertyName)
        {
            if (string.IsNullOrEmpty(propertyName))
            {
                throw new ArgumentNullException("propertyName", ValidationMessages.Invalid_PropertyName);
            }
