...
namespace RTH.Windows.ViewModels
{
    public class InsightsViewModel : ViewModelBase
    {
        ...
        private async void SetPrimaryData()
        {
        ...
        //{
        //    get {
        //        return m_selectedTabChanged ?? (m_selectedTabChanged = new RelayCommand((o) => SelectedTabChangedAction(o), (o) => true));
        //    }
        //}
        private string CurrentTabKeyString = "";

        private UserData GetUserData(Users objUser)
        {
            UserData obj = new UserData();
            //gender data
            obj.AgeGenderTitle = this.Insights.data.age_gender.age.ToString() + " " + ((this.Insights.data.age_gender.male) ? ViewModelBase.AppMessages.year_old_men : ViewModelBase.AppMessages.year_old_women);
            obj.AgeGenderScore = this.Insights.data.age_gender.GetPropValue(objUser.key_string).ToChangeType<string>();
            obj.AgeGenderColor = "";
            //age gender data

            obj.GenderTitle= ((this.Insights.data.age_gender.male) ? ViewModelBase.AppMessages.men_whole : ViewModelBase.AppMessages.women_whole);
            obj.GenderScore = this.Insights.data.gender.GetPropValue(objUser.key_string).ToChangeType<string>();
            obj.GenderColor = "";
        ...
        public bool Get_Insights()
        {
            ...
            if (objResponseInsights.message == "")
            {
                ...
                for (int i = 0; i < this.Insights.data.user.Count; i++)
                {
                    ...
                    this.Insights.data.user[i].userData= GetUserData(this.Insights.data.user[i]);
                }
            }
