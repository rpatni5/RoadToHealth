...
namespace RTH.Windows.Views
{
    public partial class MainWindow
    {
        ...
        public async void PopupOkCommandAction(object o)
        {
            ...
            if (objPasswordEntered.SecurePassword.Value() == Properties.Settings.Default.SecurePwd.Value())
            {
        ...
        public async void UpdatePasswordAction1(object o)
        {
            ...
            bool blnUpdatePassword = await SettingsViewModel.UpdatePasswordData(Properties.Settings.Default.SecurePwd.Value(), oldPasswordObj.Password, newPasswordObj.Password, confPasswordObj.Password);
        ...
        public async void DeactivationChangeAction(object o)
        {
            ...
            if (await objDeactivationViewModel.DeactivateAccountAsync(objTextBox.Text).ConfigureAwait(false))
            {
