...
namespace RTH.Business.Services
{
    public class HealthPlanServices
    {
        ...
        public static List<HealthAgenda> GetHealthAgendaPHA(string userid)
        {
            return Http.ExecuteGET<Response<List<HealthAgenda>>>(string.Format("apis/getPHAAgenda/{0}", userid), null, null).data;
        }
