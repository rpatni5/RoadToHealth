...
namespace RTH.Windows.Views.UserControls
{
    ...
    public partial class HealthPlanQuestionnaireView : ViewBase, ITutorialHost
    {
        ...
        public async void ExecuteContinueCommand(object obj)
        {
            ...
            HRASubmit a = await vm.MoveToQuestion(1, Properties.Settings.Default.SecurePwd).ConfigureAwait(false);
            Dispatcher.Invoke(() =>
            {
            ...
            {
                submitted = true;
                Dispatcher.Invoke(() => { App.SharedValues.WindowMain.LoadView(Enums.ViewEnum.StrategyView, param: ObjectiveId); });
            }
        }
