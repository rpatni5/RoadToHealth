        ...
        static Inline Traverse(string value)
        {
            ...
            if (sections.Length.Equals(1))
            {
                ...
                if (GetTokenInfo(section, out token))
                {
                    ...
                    {
                        case "h3":
                            var h3 = new Span(Traverse(content));
                            h3.FontSize = 20;
                            return h3;
                        case "h2":
                            var h2 = new Span(Traverse(content));
                            h2.FontSize = 22;
                            return h2;
                        case "h1":
                            var h1 =new Span(Traverse(content));
                            h1.FontSize = 24;
                            return h1;
                        case "h4":
                            var h4 = new Span(Traverse(content));
                            h4.FontSize = 18;
                            return h4;
                        ...
                        case "div":
                            var span = new Span(new LineBreak());
                            span.Inlines.Add(Traverse(content));
                            return span;
                        case "font":
