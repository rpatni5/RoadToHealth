...
namespace RTH.Windows.Views.UserControls
{
    public class ViewBase : UserControl, IMessagingTarget
    {
        ...
        public virtual void OnMessage(Message e)
        {
            ...
            else if (e.Type == MessageType.SaveCredentialAndLoadChatView)
            {
                User oUser = (User)e.Data;
                App.SharedValues.WindowMain.SaveCredentials(oUser.email, oUser.password);
                App.SharedValues.WindowMain.LoadView(ViewEnum.QuealthCoachView, param: "AfterLogin");
            }
        }
